...
const Actividad2A_base = ({staticContext, ...props}) => {
    ...
    return (
        <Container  { ...props } bgImage='./src/arbol.png'>
            ...
            {/* Fila */}
            <IRow justify="center" pt={1.5} gutters={0.8}>
                    <InputWords className="tree" w={7.3} ok={okInput7} err={errInput7} changeCheck={checkAnswer} idArr={7} p="0.3em 0.8em"/>
            </IRow>
            {/* Fila */}
